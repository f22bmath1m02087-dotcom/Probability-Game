...
export const GAME_CASES: GameCase[] = [
    {
        ...
        suspects: [
            ...
            { id: 'gardener', name: 'Ramisha', avatar: '👩‍🌾', attributes: { hasKitchenAccess: false, hasCrumbs: false, motive: 'revenge' }},
            { id: 'maid', name: 'Wishal the maid', avatar: '🧹', attributes: { hasKitchenAccess: true, hasCrumbs: true, motive: 'hunger' }},
            { id: 'countess', name: 'Shama', avatar: '👑', attributes: { hasKitchenAccess: false, hasCrumbs: false, motive: 'sabotage' }},
        ],
        clues: [
